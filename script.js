...
ul.setAttribute("id", "paginated-list");
ul.setAttribute("data-current-page", "1");
...
for (let index = 0; index < array.length; index++) {
  ...
  lable.innerHTML = array[index].id;
  li.append(lable);
  let label1 = document.createElement("label");
  label1.innerHTML = array[index].name;
  li.append(label1);
  let label2 = document.createElement("label");
  label2.innerHTML = array[index].email;
  li.append(label2);
}
...
button1.setAttribute("aria-label", "Previous page");
button1.setAttribute("class", "pagination-button");
button1.setAttribute("id", "prev-button");
button1.setAttribute("tittle", "Previous page");
button1.innerHTML = "<";
nav.append(button1);
let div3 = document.createElement("div");
div3.setAttribute("id", "pagination-numbers");
nav.append(div3);
let button2 = document.createElement("button");
button2.setAttribute("type", "button");
button2.setAttribute("aria-label", "Next page");
button2.setAttribute("class", "pagination-button");
button2.setAttribute("id", "next-button");
button2.setAttribute("tittle", "Next page");
button2.innerHTML = ">";
nav.append(button2);
